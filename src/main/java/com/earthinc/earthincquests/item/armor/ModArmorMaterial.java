...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    ICARUS("icarus", 50, new int[]{4, 7, 10, 4}, 15, SoundEvents.BLOCK_BEACON_DEACTIVATE, 10.0F, 1.0F, () -> {
        return Ingredient.fromItems(null);
    }),
    STARTING("icarus", 10, new int[]{1, 1, 1, 1}, 10, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 1.0F, 0F, () -> {
        return Ingredient.fromItems(null);
    });
    ;
    ...
    public String getName() {
        return EarthIncQuests.MOD_ID + ":" + this.name;
    }
